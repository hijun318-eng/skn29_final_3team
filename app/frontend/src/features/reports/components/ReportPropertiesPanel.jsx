...
export const ReportPropertiesPanel = memo(function ReportPropertiesPanel({
  ...
  const selectedSizePreset = block
    ? editorTools.sizePresets.find((preset) => (
        (block.w ?? block.columns) === preset.width && block.h === preset.height
      ))
    : null;
  ...
  return <aside className="report-properties-panel" aria-label="보고서 속성">
    ...
    <details className="report-properties-advanced">
    ...
    <details className="report-properties-advanced">
      <summary><Camera size={14} /><span>버전과 클립보드</span></summary>
      <div className="report-properties-advanced-body">
        <section>
          <h3>세션 스냅샷</h3>
