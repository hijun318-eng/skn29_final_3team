...
| OPS-010 | 프로젝트 운영 | 주간보고 연속 갱신 | 일일보고 작성 시 해당 프로젝트 주차의 주간보고를 유사 항목 통합 방식으로 자동 갱신하고 분량 제한 적용 | Codex | 🟢 DONE | P2 | 2026-07-16 | 2026-07-16 | 100 | OPS-008 | 일일보고 갱신이 같은 주차의 기존 주간보고 갱신으로 이어지고 각 주차 블록이 50줄 이내로 유지됨 | root 지침·상세 절차 연결, 기존 주차 갱신·유사 항목 통합·50줄 초과 시 재요약 규칙 및 현재 1주차 블록 41줄 확인 | `AGENTS.md`, `docs/daily_reports/README.md`, `docs/daily_reports/주간보고.md` | 2026-07-16 12:21 | 줄 수는 제목부터 다음 주차 제목 직전까지 빈 줄 포함 계산 |
