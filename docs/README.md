...
- [`Report_Assistant_V2_통합_가이드.md`](Report_Assistant_V2_통합_가이드.md): `seung` 브랜치 Report Assistant의 기능, API, 상태 전이, 파일 위치, 구현 이력, 검증 시나리오, 로컬 실행, 팀 통합 기준과 미완료 live 범위를 한 문서에서 관리한다.
