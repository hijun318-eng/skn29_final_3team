...
- [`Report_Assistant_V2_시나리오_검증보고서_20260826.md`](Report_Assistant_V2_시나리오_검증보고서_20260826.md): 기능 설명서의 시나리오를 자동 테스트와 실제 GPT·PostgreSQL·Browser 대표 흐름으로 검증한 결과와 live 미검증 범위를 기록한다.
