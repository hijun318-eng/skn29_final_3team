...
| `app/backend/app/services/unified_chat_router.py` | production | REVIEWED |
...
| `app/backend/migrations/versions/20260826_47_rag_integration.py` | runtime-config | REVIEWED |
| `app/backend/migrations/versions/20260826_48_ml_prediction_audit.py` | runtime-config | REVIEWED |
...
| `docs/e2e_mvp/derived/rag_evaluation_20260829/bm25_ablation_result.json` | documentation | REFERENCE_NON_RUNTIME |
| `docs/e2e_mvp/derived/rag_evaluation_20260829/embedding_hybrid_comparison_result.json` | documentation | REFERENCE_NON_RUNTIME |
| `docs/e2e_mvp/derived/rag_evaluation_20260829/evaluation_dataset.json` | documentation | REFERENCE_NON_RUNTIME |
| `docs/e2e_mvp/derived/rag_evaluation_20260829/RAG_BM25_Reranker_객관적평가_최종판정.md` | documentation | REFERENCE_NON_RUNTIME |
| `docs/e2e_mvp/derived/rag_evaluation_20260829/rag_live_e2e_result.json` | documentation | REFERENCE_NON_RUNTIME |
| `docs/e2e_mvp/derived/rag_evaluation_20260829/reranker_bge_gte_result.json` | documentation | REFERENCE_NON_RUNTIME |
| `docs/e2e_mvp/derived/rag_evaluation_20260829/reranker_bge_minilm_result.json` | documentation | REFERENCE_NON_RUNTIME |
...
| `scripts/rag_evaluation/evaluate_bm25_ablation.py` | production | REVIEWED |
| `scripts/rag_evaluation/evaluate_lightweight_reranker.py` | production | REVIEWED |
| `scripts/rag_evaluation/evaluate_rerankers.py` | production | REVIEWED |
| `scripts/rag_evaluation/generate_candidates.py` | production | REVIEWED |
...
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/checksums.sha256.json` | runtime-contract | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/evaluation/recent_rolling_validation.json` | runtime-contract | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/evaluation/release_comparison.json` | runtime-contract | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/evaluation/test_by_horizon.csv` | production | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/evaluation/test_by_property.csv` | production | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/evaluation/test_by_room_type.csv` | production | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/feature_contract.json` | runtime-contract | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/model.approval.json` | runtime-contract | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/model.joblib` | production | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/model_card.md` | documentation | REFERENCE_NON_RUNTIME |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/model_manifest.json` | runtime-contract | REVIEWED |
| `src/ml/artifacts/room-demand-operational-hgbr-v4.0.0/selection_trials.json` | runtime-contract | REVIEWED |
...
| `src/ml/room_demand_timeseries/build_operational_dataset.py` | production | REVIEWED |
...
| `src/ml/room_demand_timeseries/operational_aligned_benchmark.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_candidate.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_contracts.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_evaluation.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_features.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_governance.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_metrics.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_modeling.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_promote.py` | production | REVIEWED |
...
| `src/ml/room_demand_timeseries/operational_shadow_contracts.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_shadow_metrics.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_shadow_validation.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/operational_snapshot.py` | production | REVIEWED |
...
| `src/rag/answer_templates.py` | production | REVIEWED |
...
| `src/rag/evidence_answer_composer.py` | production | REVIEWED |
...
| `src/rag/manual_domain_resolver.py` | production | REVIEWED |
...
| `tests/frontend/ml-prediction-card-v4.test.mjs` | test | TEST_ONLY |
...
| `tests/ml/test_operational_governance.py` | test | TEST_ONLY |
| `tests/ml/test_operational_metrics.py` | test | TEST_ONLY |
| `tests/ml/test_operational_promotion.py` | test | TEST_ONLY |
| `tests/ml/test_operational_readiness.py` | test | TEST_ONLY |
| `tests/ml/test_operational_room_demand.py` | test | TEST_ONLY |
...
| `tests/rag/test_manual_domain_resolver.py` | test | TEST_ONLY |
