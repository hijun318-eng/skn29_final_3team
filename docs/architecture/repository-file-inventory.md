...
| `app/backend/app/adapters/openai_supervisor.py` | production | REVIEWED |
...
| `app/backend/app/services/composite_agent_execution.py` | production | REVIEWED |
...
| `app/backend/app/services/governed_mcp_execution.py` | production | REVIEWED |
...
| `app/backend/app/services/mcp_agent_tools.py` | production | REVIEWED |
...
| `app/backend/app/services/report_assistant_external_transfer.py` | production | REVIEWED |
...
| `app/backend/app/services/supervisor_planner.py` | production | REVIEWED |
| `app/backend/app/trace_examples.py` | production | REVIEWED |
| `app/backend/app/user_account_roles.py` | production | REVIEWED |
...
| `app/backend/migrations/versions/20260831_67_report_assistant_page_constraint.py` | runtime-config | REVIEWED |
| `app/backend/migrations/versions/20260831_68_mcp_registry_metadata.py` | runtime-config | REVIEWED |
| `app/backend/migrations/versions/20260831_69_analysis_artifact_runtime_lock.py` | runtime-config | REVIEWED |
...
| `data/rag/manuals/monthly_reports/2026-05_01_월간종합경영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-05_02_회계팀_월별회계손익보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-05_03_객실팀_객실운영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-05_04_시설팀_시설장애보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-05_05_식음팀_식음연회운영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-05_06_영업팀_영업판매채널보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-06_01_월간종합경영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-06_02_회계팀_월별회계손익보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-06_03_객실팀_객실운영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-06_04_시설팀_시설장애보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-06_05_식음팀_식음연회운영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-06_06_영업팀_영업판매채널보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-07_01_월간종합경영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-07_02_회계팀_월별회계손익보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-07_03_객실팀_객실운영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-07_04_시설팀_시설장애보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-07_05_식음팀_식음연회운영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-07_06_영업팀_영업판매채널보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-08_01_월간종합경영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-08_02_회계팀_월별회계손익보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-08_03_객실팀_객실운영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-08_04_시설팀_시설장애보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-08_05_식음팀_식음연회운영보고서.docx` | asset | REFERENCE_NON_RUNTIME |
| `data/rag/manuals/monthly_reports/2026-08_06_영업팀_영업판매채널보고서.docx` | asset | REFERENCE_NON_RUNTIME |
...
| `docs/daily_reports/team_summaries/5주차/Answervice_주간보고_E2E_개발현황_최종본.pptx` | documentation | REFERENCE_NON_RUNTIME |
...
| `docs/daily_reports/team_summaries/6주차/20260820.md` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/6주차/20260821.md` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/6주차/Answervice_3팀_FSD_DataHub_질문검색_개선현황_10p.pptx` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/6주차/주간보고.md` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/7주차/20260824.md` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/7주차/20260825.md` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/7주차/20260826.md` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/7주차/20260827.md` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/7주차/Answervice_주간보고.html` | documentation | REFERENCE_NON_RUNTIME |
| `docs/daily_reports/team_summaries/7주차/주간보고.md` | documentation | REFERENCE_NON_RUNTIME |
...
| `src/ml/__init__.py` | production | REVIEWED |
| `src/ml/artifacts/room-demand-hgbr-optimization-v3.3.0/feature_contract.json` | runtime-contract | REVIEWED |
| `src/ml/artifacts/room-demand-hgbr-optimization-v3.3.0/hgbr_candidate.joblib` | production | REVIEWED |
| `src/ml/artifacts/room-demand-hgbr-optimization-v3.3.0/hgbr_cv_results.csv` | production | REVIEWED |
...
| `src/ml/artifacts/room-demand-timeseries-hgbr-v2.2.0/APPROVAL_SHA256SUMS.txt` | production | REVIEWED |
...
| `src/ml/artifacts/room-demand-timeseries-hgbr-v2.2.0/model.joblib` | production | REVIEWED |
...
| `src/ml/artifacts/room-demand-timeseries-hgbr-v2.2.0/SHA256SUMS.txt` | production | REVIEWED |
| `src/ml/room_demand_timeseries/__init__.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/build_dataset.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/calendar_features.py` | production | REVIEWED |
...
| `src/ml/room_demand_timeseries/finalize_approval.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/freeze.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/hgbr_optimization_support.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/load_history_db.py` | production | REVIEWED |
| `src/ml/room_demand_timeseries/modeling.py` | production | REVIEWED |
...
| `src/ml/room_demand_v3/__init__.py` | production | REVIEWED |
| `src/ml/room_demand_v3/requirements.txt` | production | REVIEWED |
| `src/ml/room_demand_v3/trino_client.py` | production | REVIEWED |
| `src/ml/runtime_trust.py` | production | REVIEWED |
...
| `src/rag/__init__.py` | production | REVIEWED |
| `src/rag/__main__.py` | production | REVIEWED |
| `src/rag/access_policy.py` | production | REVIEWED |
| `src/rag/answer_context.py` | production | REVIEWED |
| `src/rag/answer_contracts.py` | production | REVIEWED |
| `src/rag/answer_evaluation.py` | production | REVIEWED |
| `src/rag/answer_io.py` | production | REVIEWED |
| `src/rag/answer_prompt.py` | production | REVIEWED |
| `src/rag/answer_safety.py` | production | REVIEWED |
| `src/rag/answer_service.py` | production | REVIEWED |
| `src/rag/api.py` | production | REVIEWED |
| `src/rag/application.py` | production | REVIEWED |
| `src/rag/backup_validation.py` | production | REVIEWED |
| `src/rag/baseline_benchmark.py` | production | REVIEWED |
| `src/rag/bm25.py` | production | REVIEWED |
| `src/rag/cli.py` | production | REVIEWED |
| `src/rag/contextual_query.py` | production | REVIEWED |
| `src/rag/corpus_manifest.py` | production | REVIEWED |
| `src/rag/document_ingestion.py` | production | REVIEWED |
| `src/rag/docx_ingestion.py` | production | REVIEWED |
| `src/rag/e2e/__init__.py` | production | REVIEWED |
| `src/rag/e2e/__main__.py` | production | REVIEWED |
| `src/rag/e2e/cli.py` | production | REVIEWED |
| `src/rag/e2e/clients.py` | production | REVIEWED |
| `src/rag/e2e/contracts.py` | production | REVIEWED |
| `src/rag/e2e/dashboard.py` | production | REVIEWED |
| `src/rag/e2e/manual_rag_e2e.py` | production | REVIEWED |
| `src/rag/e2e/orchestrator.py` | production | REVIEWED |
| `src/rag/e2e/security_live_probe.py` | production | REVIEWED |
| `src/rag/e2e/test_dynamic_e2e.py` | production | REVIEWED |
| `src/rag/embedding_input.py` | production | REVIEWED |
| `src/rag/embedding_provider.py` | production | REVIEWED |
| `src/rag/evaluation_service.py` | production | REVIEWED |
| `src/rag/evidence_packer.py` | production | REVIEWED |
| `src/rag/evidence_repository.py` | production | REVIEWED |
| `src/rag/integration/__init__.py` | production | REVIEWED |
| `src/rag/integration/adapters.py` | production | REVIEWED |
| `src/rag/integration/contracts.py` | production | REVIEWED |
| `src/rag/integration/coordinator.py` | production | REVIEWED |
| `src/rag/integration/dev_bridge.py` | production | REVIEWED |
| `src/rag/integration/mcp_dispatcher.py` | production | REVIEWED |
| `src/rag/integration/ml_tool.py` | production | REVIEWED |
| `src/rag/integration/rate_limit.py` | production | REVIEWED |
| `src/rag/integration/registry.py` | production | REVIEWED |
| `src/rag/integration/routing.py` | production | REVIEWED |
| `src/rag/integration/sql_adapter.py` | production | REVIEWED |
| `src/rag/integration/tool_service.py` | production | REVIEWED |
| `src/rag/lifecycle_fixture.py` | production | REVIEWED |
| `src/rag/lifecycle_repository.py` | production | REVIEWED |
| `src/rag/llm_failure_diagnostics.py` | production | REVIEWED |
| `src/rag/local_answer_service.py` | production | REVIEWED |
| `src/rag/manual_article_formatter.py` | production | REVIEWED |
| `src/rag/manual_comparison_formatter.py` | production | REVIEWED |
| `src/rag/manual_evaluation_metrics.py` | production | REVIEWED |
| `src/rag/manual_question_evaluation.py` | production | REVIEWED |
| `src/rag/models.py` | production | REVIEWED |
| `src/rag/p2_contracts.py` | production | REVIEWED |
| `src/rag/pdf_ingestion.py` | production | REVIEWED |
| `src/rag/pgvector_observability.py` | production | REVIEWED |
| `src/rag/pgvector_repository.py` | production | REVIEWED |
| `src/rag/processing_profile.py` | production | REVIEWED |
| `src/rag/quality_evaluation.py` | production | REVIEWED |
| `src/rag/question_report.py` | production | REVIEWED |
| `src/rag/qwen_embedding.py` | production | REVIEWED |
| `src/rag/README.md` | documentation | REFERENCE_NON_RUNTIME |
| `src/rag/repair_manual_record_descriptions.py` | production | REVIEWED |
| `src/rag/repair_manual_transition_controls.py` | production | REVIEWED |
| `src/rag/report_evidence_formatter.py` | production | REVIEWED |
| `src/rag/repository.py` | production | REVIEWED |
| `src/rag/request_auth.py` | production | REVIEWED |
| `src/rag/reranker.py` | production | REVIEWED |
| `src/rag/response_normalizer.py` | production | REVIEWED |
| `src/rag/retrieval_service.py` | production | REVIEWED |
| `src/rag/runtime_device.py` | production | REVIEWED |
| `src/rag/security_audit_repository.py` | production | REVIEWED |
| `src/rag/source_bytes.py` | production | REVIEWED |
| `src/rag/text_processing.py` | production | REVIEWED |
| `src/rag/token_chunker.py` | production | REVIEWED |
| `src/rag/vector_application.py` | production | REVIEWED |
| `src/rag/vector_cli.py` | production | REVIEWED |
| `src/rag/vector_models.py` | production | REVIEWED |
| `src/rag/vector_result_mapper.py` | production | REVIEWED |
| `src/rag/vector_search_payload.py` | production | REVIEWED |
| `src/rag/vector_settings.py` | production | REVIEWED |
...
| `tests/backend/test_governed_mcp_execution.py` | test | TEST_ONLY |
| `tests/backend/test_http_runtime.py` | test | TEST_ONLY |
| `tests/backend/test_langgraph_agent_runtime.py` | test | TEST_ONLY |
| `tests/backend/test_mcp_activation_migration.py` | test | TEST_ONLY |
| `tests/backend/test_mcp_agent_tools.py` | test | TEST_ONLY |
| `tests/backend/test_mcp_candidate_descriptor_migration.py` | test | TEST_ONLY |
| `tests/backend/test_mcp_protocol.py` | test | TEST_ONLY |
| `tests/backend/test_mcp_registry_metadata_migration.py` | test | TEST_ONLY |
...
| `tests/backend/test_ml_openapi_contract.py` | test | TEST_ONLY |
...
| `tests/backend/test_openai_supervisor_planner.py` | test | TEST_ONLY |
...
| `tests/backend/test_report_assistant_external_transfer.py` | test | TEST_ONLY |
| `tests/backend/test_report_assistant_external_transfer_migration.py` | test | TEST_ONLY |
| `tests/backend/test_report_assistant_http_boundary.py` | test | TEST_ONLY |
| `tests/backend/test_report_assistant_legacy_retirement.py` | test | TEST_ONLY |
...
| `tests/backend/test_supervisor_planning.py` | test | TEST_ONLY |
| `tests/backend/test_trino_schema.py` | test | TEST_ONLY |
| `tests/backend/test_user_account_role_contract.py` | test | TEST_ONLY |
...
| `tests/frontend/account-role-contract.test.mjs` | test | TEST_ONLY |
...
| `tests/ml/test_release_policy_inputs.py` | test | TEST_ONLY |
| `tests/rag/test_answer_safety_p0.py` | test | TEST_ONLY |
| `tests/rag/test_answer_service.py` | test | TEST_ONLY |
...
| `tests/rag/test_document_ingestion.py` | test | TEST_ONLY |
