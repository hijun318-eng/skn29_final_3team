...
로컬 설치·실행·검증·종료 절차는 [`LOCAL_SETUP.md`](LOCAL_SETUP.md)에서 관리한다. root `README.md`는 프로젝트 소개와 빠른 시작만 제공한다.
...
4. 현재 상태와 다음 순서는 `derived/21_AI_작업_인수인계_현재진행상황.md`
...
| 파일 | 용도 |
|---|---|
| `LOCAL_SETUP.md` | 로컬 환경 준비, 실행, 검증, 문제 확인과 종료 절차 |
