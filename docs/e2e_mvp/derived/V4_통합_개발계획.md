...
이 문서는 Walkerhill 고정 v4 후보를 전제로 한 2026-08-13 계획이며 현재 release·데이터·런타임 지시로 사용하지 않는다. 현행 기준은 저장소 루트 [`AGENTS.md`](../../../AGENTS.md), [`docs/product/`](../../product/), [`production-integrity-audit.md`](../../architecture/production-integrity-audit.md)다.
