...
| 1.7★ | 데이터 항목·시간/grain·권한·8 intent(핵심 4종 P0 우선 E2E)·평가 분리·LLM 모델 최소 합의 | 요구사항·연동 기준 합의 기록 | 박준희·김재홍·정승·윤대성 | 검토 | 07/27 | 07/28 |  |
...
| 5.6 | B·D 연동 기준·Fallback 수용 기준·아키텍처 문서화 | AI 시스템 아키텍처 | 박준희 | 진행 | 08/07 | 08/11 | **08/14** |
...
| 모델링 및 평가 | AI 시스템 아키텍처 | **08/14** | 08/13 | 5.6 | 박준희 | 진행 |
...
|---|---|---|---|
| 2026-07-21 | 5.6 | 기존 요구사항·기획·화면 산출물을 기반으로 Django 신뢰 경계, FastAPI read-only 분석, 기능 A 결정론 pipeline, 기능 B 제한 LangGraph, PostgreSQL lineage, LLM·fallback·평가 기준을 포함한 AI 시스템 아키텍처 초안 작성 | `docs/markdown/12_AI시스템아키텍처_초안.md` |
