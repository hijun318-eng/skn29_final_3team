...
| 1.7★ | 데이터 항목·시간/grain·권한·8 intent(핵심 4종 P0 우선 E2E)·평가 분리·LLM 모델 최소 합의 | 요구사항·WISE 적용·연동 기준·백엔드 경계 합의 기록 | 박준희·김재홍·정승·윤대성 | 검토 | 07/27 | 07/28 |  |
