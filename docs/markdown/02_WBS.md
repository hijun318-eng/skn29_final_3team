...
|---|---|---|---|
| 2026-07-21 | 1.7, 2.9, 6.9, 6.14 | 구현 전 백엔드 작업영역과 FastAPI 내부·외부 연동 경계를 검토하고, WISE·WISE 2.0 공개 사례의 semantic catalog·자연어 조회·자동 분석 적용 범위와 제외 조건을 초안으로 정리 | 백엔드 작업영역·FastAPI 연동 범위·WISE 벤치마킹 적용안 |
