...
|---|---|---|---|
| 2026-07-23 11:53 | 1.3, 1.5, 1.7, 2.1, 2.3, 2.7~2.9, 5.2, 5.4, 5.9, 6.2~6.4, 6.13 | 04·05와 기능 메모를 기준으로 A~D 기능, 최소 업무 테이블, 원본/학습 리뷰 분리, 평점 우선·저점 리뷰 추가 질의, 담당자 알림·모니터링 범위를 01~03 산출물에 동기화 | `docs/markdown/01_요구사항정의서.md`, `docs/markdown/02_WBS.md`, `docs/markdown/03_프로젝트기획서.md` |
...
| 2026-07-21 | 1.7, 2.9, 5.3, 5.4, 5.9, 6.3, 6.7, 6.9 | WISE 벤치마킹 중복 문서를 단일 기준 문서로 통합하고 공식 사실·수치 제한·시맨틱 관계·질의·Trigger·Agent·AI Guide 경계와 수용 기준을 선별 정리 | `docs/markdown/ai_docs/워커힐_WISE_벤치마킹_적용안.md`, 중복 문서 제거, 문서 형식·참조 경로 검증 |
...
| 버전 | 일시 | 요약 |
|---|---|---|
| v4.2 | 2026-07-23 11:53 | 기존 일정·담당·상태를 유지하고 A~D 기능·최소 데이터 구조·리뷰 lineage·알림·모니터링 작업 범위와 기획 추적 관점을 동기화 |
| v4.1 | 2026-07-23 11:35 | `dev` 최신 WBS 이력을 보존하면서 ChatGPT/Codex OAuth 기반 OpenWiki 초기화와 생성 위키 근거를 통합 |
| v4.0 | 2026-07-23 10:14 | `dev` 최신 실행 기준을 유지하면서 AI 참고 자료 폴더 분류·화면설계서 확정 경로·검증 지침을 통합 |
...
| v3.2 | 2026-07-22 15:08 | 10:27·10:39 문서 헤더 정리와 15:08 문서관리규칙 정합화 기록을 시간순으로 병합 |
