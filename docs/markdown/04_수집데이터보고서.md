...
| 문서 분류 | 산출물 작업본 |
| 버전 | v1.1 |
| 문서 기준일 | 2026-07-30 11:57 |
| 작성·수정 | 김재홍 |
| 산출물 번호 | 04 |
| 제출 일자 | — |
| 대응 템플릿 | `templates/[데이터 수집 및 저장] 수집 데이터 보고서_27기_0팀.docx` |

근거 문서: `04_수집데이터보고서_29기_3팀.docx`, `[별첨]데이터테이블명세서.xlsx`, `Answervice_기획서.md`
...
| 버전 | 일시 | 요약 |
|---|---|---|
| v1.1 | 2026-07-30 11:57 | 삭제된 데이터베이스 저장소 설계 XLSX 참조를 현재 별첨 테이블 명세서로 교체 |
