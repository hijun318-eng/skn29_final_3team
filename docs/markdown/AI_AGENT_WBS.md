...
|---|---|---|---|---|---|---|---|---|---:|---|---|---|---|---|---|
| PLAN-001 | 기획 | 프로젝트 범위 정의 | 호텔 VOC/운영 이슈 분석 Agent의 사용자·문제·범위·제외 범위와 합성 데이터 원칙 정의 | daesung | 🟠 REVIEW | P1 | 2026-07-20 | 2026-07-24 | 100 | - | 사용자, 문제, 범위와 제외 범위가 문서화됨 | 기획서 초안에서 사용자·시스템 경계, 합성 데이터 원칙, 중간발표·Baseline 단계, 완료 조건을 확인 | `docs/markdown/SensePlace_기획서_초안.md` | 2026-07-20 | 팀 검토 후 범위와 일정 확정 필요 |
...
|---|---|---|---|---|---|---|
| 2026-07-20 | PLAN-001 | Codex | Hotel Signal AI 기획서 초안을 추가하고 WBS 산출물을 갱신한 작업을 일일·주간보고에 반영 | TODO → REVIEW | 기획서의 사용자·범위·제외 범위·합성 데이터 원칙·단계별 완료 조건 확인 | `docs/markdown/SensePlace_기획서_초안.md`, `docs/deliverables/02_WBS_29기_3팀.xlsx`, `docs/markdown/daily_reports/daesung/일일보고.md`, `docs/markdown/daily_reports/주간보고.md`, `docs/markdown/AI_AGENT_WBS.md` |
