...
Codex가 개인 branch의 `dev` 병합을 수행할 때는 `.agents/skills/merge-branch-to-dev/SKILL.md`를 적용한다. Skill은 이 문서의 Git 정책과 `docs/markdown/daily_reports/README.md`의 보고 정책을 읽고 source push, local/remote 일치, 최신 `dev`, merge, 보고 통합·검증, 최종 push를 순서대로 수행한다.
...
| 버전 | 일시 | 요약 |
|---|---|---|
| v1.1 | 2026-07-21 17:32 | Codex의 개인 branch→dev 반복 절차를 `merge-branch-to-dev` Skill로 분리 |
