# R1 Gate 원장 경로 정합성 패치 제안서 Archive

| 항목 | 내용 |
|---|---|
| 문서 설명 | `Gate_실행_카드_원장.md`의 허용 경로가 실제 소스 트리와 어긋난 3건에 대한 R1 승인 결과 |
| 문서 분류 | 일반 문서 |
| 버전 | v1.2 |
| 문서 기준일 | 2026-08-11 17:40 |
| 작성·수정 | 윤대성·박준희 / 3팀 사용자 요청·Codex 반영 |
| 승인 상태 | **1·2·3·4·6·7 승인, 5 보류** |

> 승인 항목은 `Gate_실행_카드_원장.md` v2.15에 반영했다. `app/react/**` 삭제는 별도 결정 전까지 보류하며 이 문서는 판단 근거로 보존한다.

> 이 문서는 완료된 의사결정의 읽기 전용 archive다. 현재 경로·권한·실행 상태는 [Gate 실행 카드 원장](../Gate_실행_카드_원장.md), `AGENTS.md`, I0 계약을 따른다.
...
| 버전 | 일시 | 요약 |
|---|---|---|
| v1.2 | 2026-08-11 17:40 | 반영 완료 제안서를 archive로 이동하고 현재 실행 정본 링크를 명시 |
| v1.1 | 2026-07-31 11:24 | R1이 1·2·3·4·6·7번을 승인해 Gate 원장 v2.15에 반영하고 `app/react/**` 삭제는 별도 결정으로 보류 |
