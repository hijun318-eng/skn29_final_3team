...
> **SUPERSEDED / 현행 평가 근거로 사용 금지**
> 이 문서는 2026-08-19 코드 기준 기록이며, 이후 catalog TTL·canonical Role·Join 확장 권한·Metric governance가 변경됐다. 현행 평가는 [`DataHub_사용_방식_객관적_재평가_및_실사용_사례_2026-08-20.md`](DataHub_사용_방식_객관적_재평가_및_실사용_사례_2026-08-20.md)를 사용한다.
