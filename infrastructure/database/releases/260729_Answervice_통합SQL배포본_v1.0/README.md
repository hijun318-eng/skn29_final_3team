...
- `01_SQL_결과물/`: 역할별 SQL 원본 21개, manifest, 정적 검증보고서
...
접속정보가 있어도 실행 승인으로 간주하지 않는다. Source DB·Trino 적용은 데이터 담당, Application DB·Alembic 적용은 백엔드 담당, 공유 환경 적용은 PM의 명시적 승인이 필요하다.
