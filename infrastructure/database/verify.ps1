...
$catalogs = Invoke-Compose -Arguments @('exec', '-T', 'trino', 'trino', '--server', 'http://localhost:8080', '--user', 'hotel_synthetic_verify', '--output-format', 'CSV_UNQUOTED', '--execute', 'SHOW CATALOGS')
