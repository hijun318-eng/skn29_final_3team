...
_PROMPTS = {
    "node1.normalize": PromptRecord(
        "node1.normalize", "PROMPT-v1.25.0", "node1", "development", "base", None,
        "DRAFT-BASE-v0.1",
