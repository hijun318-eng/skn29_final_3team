...
_PROMPTS = {
    ...
    "node2.sql": PromptRecord(
        ...
        None,
        "DRAFT-BASE-v0.1",
        "반드시 설명·Markdown·references·parameters 없이 {\"sql\":\"한 줄 SQL\"} JSON 객체 하나만 반환한다. "
        ...
        "asset에 property_id가 있으면 property_id = 'SYNTHETIC_HOTEL_001'을 적용하고, data_period_status가 있으면 'ACTUAL', is_forecast가 있으면 false로 제한한다. "
