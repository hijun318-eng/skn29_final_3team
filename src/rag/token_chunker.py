...
class TokenChunker:
    ...
    def _add_chunk(chunks: list[PdfChunk], manual_id: str, page_number: int, section_title: str, text: str, token_count: int) -> None:
        ...
        chunks.append(PdfChunk(chunk_id=chunk_id, manual_id=manual_id, page_start=page_number, page_end=page_number, section_title=section_title, content=text, checksum=checksum, token_count=token_count))
