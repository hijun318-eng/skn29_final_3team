...
assert.match(appStyles, /\.report-builder-v2-mode>\.workspace\{height:100%;min-height:0;display:grid;grid-template-rows:auto minmax\(0,1fr\);overflow:hidden\}/);
assert.match(appStyles, /\.report-builder-v2-mode>\.workspace>\.page-stage\{height:auto;min-height:0;overflow:hidden;padding:0\}/);
assert.doesNotMatch(appStyles, /\.report-builder-v2-mode>\.workspace>\.topbar\{display:none\}/);
