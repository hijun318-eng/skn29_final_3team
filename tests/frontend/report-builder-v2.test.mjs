...
assert.match(builderStyles, /\.builder-library-column\{position:absolute;[^}]*width:min\(var\(--builder-library\),calc\(100vw - 56px\)\)/);
assert.match(builderStyles, /\.builder-inspector\{position:absolute;[^}]*width:min\(var\(--builder-properties\),calc\(100vw - 56px\)\)/);
