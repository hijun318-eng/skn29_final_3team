...
assert.match(builderStyles, /@media\(max-width:900px\)\{[\s\S]*\.editor-command-actions\{[^}]*overflow-x:auto;[^}]*scrollbar-width:none/);
assert.match(builderStyles, /\.editor-command-actions::-webkit-scrollbar\{display:none\}/);
assert.match(builderStyles, /\.editor-command-actions>\.primary\{[^}]*position:sticky;[^}]*right:0;[^}]*margin-left:auto/);
